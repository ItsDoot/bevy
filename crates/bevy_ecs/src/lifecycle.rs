...
//! Similarly, [`Insert`] and [`Discard`] are counterparts: they are triggered when a component is added to or discarded
//! from an entity, regardless of whether this results in a change in the component's presence on that entity.
//!
