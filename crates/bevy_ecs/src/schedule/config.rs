...
use crate::{
    ...
    system::{IntoSystem, ScheduleCondition, ScheduleSystem, System},
};
...
fn new_condition<M>(condition: impl SystemCondition<M>) -> ScheduleCondition {
    ...
    ScheduleCondition::from(condition_system)
}
    ...
    F: IntoSystem<(), (), Marker>,
{
    fn into_configs(self) -> ScheduleConfigs<ScheduleSystem> {
        let system = ScheduleSystem::from(IntoSystem::into_system(self));
        ScheduleConfigs::ScheduleConfig(system.into_config())
    }
}
