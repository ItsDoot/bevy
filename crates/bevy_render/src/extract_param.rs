...
pub struct Extract<'w, 's, P, I = ()>
where
    P: ReadOnlySystemParam<I> + 'static,
    I: SystemInput + 'static,
{
    item: SystemParamItem<'w, 's, P, I>,
}

#[doc(hidden)]
pub struct ExtractState<P: SystemParam<I> + 'static, I: SystemInput + 'static = ()> {
    state: SystemState<P, I>,
    main_world_state: <Res<'static, MainWorld> as SystemParam<I>>::State,
}

// SAFETY: The only `World` access (`Res<MainWorld>`) is read-only.
unsafe impl<P, I> ReadOnlySystemParam<I> for Extract<'_, '_, P, I>
where
    P: ReadOnlySystemParam<I>,
    I: SystemInput,
{
}
...
unsafe impl<P, I> SystemParam<I> for Extract<'_, '_, P, I>
where
    P: ReadOnlySystemParam<I>,
    I: SystemInput,
{
    type State = ExtractState<P, I>;
    type Item<'w, 's> = Extract<'w, 's, P, I>;

    fn init_state(world: &mut World, system_meta: &mut SystemMeta) -> Self::State {
        let mut main_world = world.resource_mut::<MainWorld>();
        ExtractState {
            state: SystemState::new(&mut main_world),
            main_world_state: <Res<MainWorld> as SystemParam<I>>::init_state(world, system_meta),
        }
    }
    ...
    unsafe fn validate_param(
        ...
        let Some(main_world) = result else {
            system_meta.try_warn_param::<&World, I>();
            return false;
        };
        ...
        unsafe {
            SystemState::<P, I>::validate_param(
                &state.state,
    ...
    unsafe fn get_param<'w, 's>(
        ...
        let main_world = unsafe {
            <Res<MainWorld> as SystemParam<I>>::get_param(
...
impl<'w, 's, P, I> Deref for Extract<'w, 's, P, I>
where
    P: ReadOnlySystemParam<I>,
    I: SystemInput,
{
...
impl<'w, 's, P, I> DerefMut for Extract<'w, 's, P, I>
where
    P: ReadOnlySystemParam<I>,
    I: SystemInput,
{
...
impl<'a, 'w, 's, P, I> IntoIterator for &'a Extract<'w, 's, P, I>
where
    P: ReadOnlySystemParam<I>,
    &'a SystemParamItem<'w, 's, P, I>: IntoIterator,
    I: SystemInput,
{
    type Item = <&'a SystemParamItem<'w, 's, P, I> as IntoIterator>::Item;
    type IntoIter = <&'a SystemParamItem<'w, 's, P, I> as IntoIterator>::IntoIter;
